...
import { SwitchButton } from "./../../../utils/animation/framerSwitch";
import { LayoutTheadAction, TheadActionsButton } from "../TheadGrid";
        ...
        <motion.tbody variants={gridContainerAnimation} animate="show" initial="hidden" exit="exit">
            <motion.tr variants={trAnimation} style={{ position: "relative", height: 150 }}>
                <td>
                    ...
                    {errMsn ||"¡Oops hubo un error! por favor intentelo más tarde"}
                    </h4>
                </td>
            </motion.tr>
        </motion.tbody>
